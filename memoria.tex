...
\juradoUNO{Mg. Ing. Sergio Burgos (UTN, Facultad Regional Paraná)} % Nombre y pertenencia del un jurado se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \jur1name
\juradoDOS{Esp B. Sc. Daniel Iván Cruz Flores (UBA, Facultad de Ingeniería) } % Nombre y pertenencia del un jurado se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \jur2name
\juradoTRES{Esp. Ing. Luis Mariano Campos (Conicet)} % Nombre y pertenencia del un jurado se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \jur3name
...
\dedicatory{\textbf{Dedicado a todas las personas que participaron en mi formación humana.}}  % escribir acá si se desea una dedicatoria
