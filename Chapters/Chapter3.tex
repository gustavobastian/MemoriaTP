...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=.65]{./Figures/dB(bed).png}
	\caption{Tabla Camas.}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=.65]{./Figures/dB(patient).png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=.65]{./Figures/Events.png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=.65]{./Figures/logEvents.png}
