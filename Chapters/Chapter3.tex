...
El broker Mosquitto es una parte central del sistema ya que se encarga de distribuir los mensajes entre los distintos elementos del sistema. Su instalación, en un entorno operativo Ubuntu se realiza con los siguientes comandos:
