...
Para ejecutar la collección con Newman existen varias opciones, en este trabajo ses utiliza cli y htmlextra, ejecutando en la consola:
\pagebreak
...
\begin{itemize}
 	...
 	\text{sudo echo ''America/Argentina/Buenos\_ Aires''} \\
	\mid \text{sudo tee /etc/timezone} \\
	\text{sudo dpkg-reconfigure --frontend noninteractive tzdata} \\
	\text{sudo reboot}
\end{itemize}	
\item Instalar Git:
