...
\label{IntroGeneral}
En este capítulo se presentan nociones sobre la necesidad que satisface el trabajo y el contexto en el que se realizó.
%----------------------------------------------------------------------------------------
...
%----------------------------------------------------------------------------------------
\section{Descripción de los sistemas de Internet de las cosas}
...
Por otra parte, dentro de las múltiples opciones para realizar la comunicación entre los dispositivos IoT, el protocolo Message Queuing Telemetry Transport (en adelante MQTT) se ha probado como un protocolo confiable, altamente eficiente y ampliamente utilizado\citep{ARTICLE:2}.

MQTT es un protocolo open source simple, liviano y orientado a dispositivos con pocos recursos y baja velocidad de transmisión. Está basado en la pila TCP/IP, se implementa en la capa de aplicación y utiliza mensajeria bajo el patrón de publicación/subscripción.
...
de las habitaciones.
El resultado del trabajo es un sistema con las ventajas que provee el protocolo MQTT, como es la posibilidad de agregar accesorios rápidamente con bajo costo de software, hardware e implementación.
...
Los componentes resultante contienen un sistema que contenga un
